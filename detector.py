            ...
            while True:
                ...
                if index%self._search_size==0:
                    ...
                    if len(fft_hist)>25: # grace period after start of file
                        ...
                        peak=peakl[peakidx]
                        while(peak>self._threshold and burst_mute==0):
                            signals+=1
                            burst_signals+=1
                            ...
                            if self._verbose:
                                print "New peak:",
                                print "Peak t=%5d (%4.1f dB) %.0f Hz"%info
                    ...
                    for peak in peaks_to_collect:
                        data_collector(peak[3][0], peak[3][1], peak[3][2], peak[4])
